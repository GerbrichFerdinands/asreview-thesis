...
Descriptive statistics on the five systematic reviews can be found in Table `r table_nums("datasets", display = "cite")`. 
...
#### hall 
The review [@Hall2012], is reviewed in [@Yu2016]. 

#### nudging
The review [@Nagtegaal2019]
