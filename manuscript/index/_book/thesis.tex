...
\hypertarget{ASReview}{%
\chapter{ASReview}\label{ASReview}}
\begin{itemize}
\item
...
\NormalTok{  devtools}\OperatorTok{::}\KeywordTok{install\_github}\NormalTok{(}\StringTok{"ismayc/thesisdown"}\NormalTok{)}
