...
```{r}
knitr::include_graphics("figs/myfirstsim/Figure_1.png")
```
...
```{r}
knitr::include_graphics("figs/myfirstsim/Figure_2.png")
```
...
```{r}
knitr::include_graphics("figs/myfirstsim/Figure_3.png")
```
...
```{r}
knitr::include_graphics("figs/myfirstsim/computation.png")
```
2191 was best performing with a loss of 0.1124

```{r}
knitr::include_graphics("figs/myfirstsim/optmizationresult.png")
```
