...
The `trials` folder transforms the hyperparameter output  

The `config` folder contains all sets of optimal hyperparameters. 

The current readme file preprocesses the optimal hyperparameters into an `.RDS` file for a visual inspection of the hyperparameters given below. 

If you have no access to Cartesius you can run optimization trials on your own device by running the following type of commands: 
