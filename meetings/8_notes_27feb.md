...
# Meeting
- Datasets check
  - Yu is wrong citation! 
  - Wilson now added
  - Nagtegaal (nudging) in preproceessing phase. 
  
- Can we create a slack channel for contributors? e.a. hannah ewald., to link to on contributors page. 

# To do
- [x] e-mail Lars Tummers/Rosanna Nagtegaal about dataset (118 vs 100) --> what is wrong? 
